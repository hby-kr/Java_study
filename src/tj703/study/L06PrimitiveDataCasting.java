...
public class L06PrimitiveDataCasting {
   ...
   public static void main(String[] args) {
      ...
      //i= 3147483647;
      // jvm 은 정수int를 21억 이상 표기할 수 없다.(표기와 대입 둘다 불가능)
      ...
      //강제 형변환 (Casting)
      // 한 데이터 타입을 다른 데이터 타입으로 변환하는 방법을 말합니다.
      // 주로 기본형 데이터 타입(primitive type) 간에 사용되며, 특정 타입 간에 값이 호환되지 않을 때 명시적으로 변환을 해야 할 때 사용
      // cf. parsing : 완전히 다른 타입의 데이터를 변환 String=>int,String=>Oject)
