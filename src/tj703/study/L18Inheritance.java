...
클래스 간의 관계를 통해서 상속의 상하관계를 정의하고, 생성된느 객체들은 이 클래스들의 인스턴스가 되어 상속을 받는 방식.
...
?? js에서도 class문법을 사용하잖아? 이건 뭘까.
 JavaScript의 class는 문법적 설탕(syntactic sugar). 즉, 클래스는 실제로 프로토타입 기반 상속을 사용하기 위한 더 간단하고 읽기 쉬운 문법을 제공하는 방법일 뿐.
?? 그럼 js에서 함수는?
...
//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
      ...
      * 다형성  (중요!!!)
      ...
      이 경우, o는 String 객체를 참조하지만, Object 클래스에서 정의된 메서드만 사용할 수 있습니다. String 클래스에서 제공하는 String 특화된 메서드는 사용할 수 없습니다.
      반면, s는 String 객체의 전체 성질을 참조하고, String 클래스에 정의된 특화된 메서드들(예: length(), charAt(), substring() 등)을 사용할 수 있습니다.
