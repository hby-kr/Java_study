...
// 자바 파일에는 같은 이름의 public class가 하나만 있을 수 있습니다. 파일명과 클래스명이 꼭 같아야 한다.
// 그래서 java파일에서 public class와 다른 클래스를 정의하면, 클래스 이름으로 java파일이 생성된다.
// 그래서 java파일의 public class 외 다른 클래스는 import한다.
